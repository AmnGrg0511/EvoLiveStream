...
function OneToMany() {
    ...
    useEffect(()=>{
        setInterval(()=>{
            setIndex(prev => (prev+1)%(Browsemorewayscontent.length-1))
        }, 5000)
    }, [])
    ...
    <>
      <div className="oneToMany-Welcomepart">
        <div className="oneToMany-Welcomepart-contentmain">
          <div className="oneToMany-Welcomepart-content">
            <h1 class="oneToMany-heading">
              {" "}
              Unlock the power of
              <br /> Interactive Live Video Shopping
            </h1>
          </div>
          <div className="oneToMany-Welcomepart-content">
        ...
        <div className="oneToMany-Welcomepart-img">
          <img
            src="./images/one-to-many-top-banner-min.png"
            className="oneToMany-banner"
          ></img>
        </div>
      </div>
      <div className="oneToMany-join">
        <div className="oneToMany-join-sub">
          ...
          <div className="oneToMany-join-content">
            <p className="oneClickJoin-content">
              No download required for your audience to join. Whether you’re
              reaching out to them via social media, push notifications, or
              WhatsApp — all they have to do is click on a link.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="Analysis-main">
        ...
        <p className="Analysis-content">
          Simply plug Swirl into your website or app to accelerate your sales.
        </p>
        <img
          src="./images/analytics-dashboard-of-swirl-min.png"
        ...
        <div className="Customerstory-sub">
          <div className="Customerstory-content">
            <div className="Customerstory-heading">
              <h1
                class="Customerstory-heading-sub"
            ...
            <div className="Customerstory-content-sub">
              <p>
                <span style={{ fontWeight: 400 }}>
                  A premium jewelry brand named Zariin increased their sales by{" "}
                </span>
                <span style={{ color: "#8462d0" }}>
                  <b>32%</b>
                </span>
                <span style={{ fontWeight: 400 }}>
                  {" "}
                ...
                <span style={{ fontWeight: 400 }}>
                  {" "}
                  using Swirl Live video shopping in a span of two months with
                  an over{" "}
                </span>
                <span style={{ color: "#8462d0" }}>
                  <b>3X</b>
            ...
            <div className="Customerstory-icons">
              <img
                src="./images/Zariin-Statistics.jpg"
                className="Customerstory-icons-sub"
              ></img>
            </div>
          ...
          <div className="Customerstory-img">
            <img
              src="./images/zariin-case-study-min.png"
              className="Zara"
            ></img>
          </div>
        </div>
      ...
      <div className="Requestdemo-main">
        <div className="Requestdemo-sub">
          ...
          <p style={{ textAlign: "center", lineHeight: 1.6 }}>
            ...
            >
              Using Shopify?{" "}
              <span style={{ color: "#8364d1", fontSize: "18px" }}>
                <a
                  style={{ color: "#8364d1", fontSize: "18px" }}
                  href="https://www.goswirl.live/"
                  target="_blank"
                  rel="noopener"
                >
                  Know more here.
      ...
      <div className="Browsemoreways-main">
        <div className="Browsemoreways-sub">
          <h1 className="Browsemoreways-heading">
            Browse more ways to use Swirls
          </h1>
          <div style={{overflow: "hidden", width: "100%"}}>
            <div className="Browsemoreways-card-main" style={{transform: `translateX(-${index*570}px)`, transition: "all .3s ease-in-out"}}>
              {Browsemorewayscontent.map((element) => {
                return (
                  <Browsemoreways
                    content={element.content}
                    imgurl={element.imgurl}
                    buttoncontent={element.buttoncontent}
                  />
                );
              })}
            </div>
