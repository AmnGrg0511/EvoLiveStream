            ...
            <div className="Requestdemo-main">
                <div className="Requestdemo-sub">
                    ...
                    <p style={{textAlign:"center",lineHeight:1.6}}>
                        ...
                        <span style={{fontWeight: 400,color:"white",textAlign:"center",fontSize:"18px"}}>Using Shopify? <span style={{color: "#8364d1",fontSize:"18px"}}><a style={{color: "#8364d1",fontSize:"18px"}} href="https://www.goswirl.live/" target="_blank" rel="noopener">Know more here.</a>
                        </span>
                        </span>
                    </p>
                </div> 
